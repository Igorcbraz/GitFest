...
const ScrollAnimatedText = () => {
  ...
  useEffect(() => {
    const handleWheel = (e: WheelEvent) => {
      ...
      // Permite sair facilmente nos extremos
      if ((isAtTop && scrollingUp) || (isAtBottom && scrollingDown)) {
        scrollAttempts.current++;
        // Após 2 tentativas suaves, deixa sair
...
export default function LandingPage() {
  ...
  useEffect(() => {
    setIsVisible(true);
    // Autofocus no input após a animação inicial
            ...
            <div className={`flex items-center gap-8 pt-4 transition-all duration-700 delay-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                <div className="flex items-center gap-2 hover:scale-105 transition-transform duration-300">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">
                    Join <strong className="text-gray-900 dark:text-white animate-pulse">1000+</strong> developers
                  </span>
                </div>
                <div className="flex items-center gap-1 hover:scale-105 transition-transform duration-300">
                  ...
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">
                    <strong className="text-gray-900 dark:text-white">5.0</strong> rated
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-20 text-center">
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-primary-500/10 via-secondary-500/10 to-primary-500/10 backdrop-blur-sm border border-primary-300/30 dark:border-primary-600/30 hover:scale-105 transition-all duration-300 animate-bounce-soft">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  Trusted by <strong className="text-primary-600 dark:text-primary-400">1000+</strong> developers worldwide
                </span>
              </div>
            </div>
          </div>
                      ...
                      <div className="flex items-center justify-center gap-3">
                        <div className="flex -space-x-2">
                          {[1, 2, 3, 4, 5].map((i) => (
                            <div
                              key={i}
                              className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 border-3 border-white dark:border-zinc-800 flex items-center justify-center text-white text-xs font-bold"
                            >
                        ...
                        <div className="text-left">
                          <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                            <strong className="text-primary-600 dark:text-primary-400">1,000+</strong> developers
                          </p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">already created their lineup</p>
                        </div>
                      </div>
                    </div>
                  </div>
