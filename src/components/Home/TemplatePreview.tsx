...
import { RockInRioTemplate } from '../../components/Templates/RockInRio'
...
export default function TemplatePreview({ username, data, invertColors, theme }: { username: string; data: string[]; invertColors: boolean; theme: 'dark' | 'light' | 'gitfest-rio' }) {
