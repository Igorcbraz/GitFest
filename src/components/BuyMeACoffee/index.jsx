export const BuyMeACoffee = ({ containerClassName, coffeeClassName = 'fill-[#FFDD06]', borderClassName = 'fill-[#010202]' }) => {
  return (
    <svg className={containerClassName} version='1.0' id='katman_1' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 600 450' xmlSpace='preserve'>
      ...
      <path className={borderClassName} d='M390.1,137.2C390.1,137.2,390.1,137.2,390.1,137.2C390,137.2,390,137.2,390.1,137.2
      ...
      <path className={borderClassName} d='M297,366.2c-0.3,0.1-0.6,0.3-0.8,0.6l0.2-0.2C296.7,366.4,296.9,366.3,297,366.2z'/>
      <path className={borderClassName} d='M351.5,355.4c0-0.3-0.2-0.3-0.1,0.9c0-0.1,0-0.2,0.1-0.3C351.4,355.9,351.4,355.7,351.5,355.4z'/>
      <path className={borderClassName} d='M345.8,366.2c-0.3,0.1-0.6,0.3-0.8,0.6l0.2-0.2C345.5,366.4,345.7,366.3,345.8,366.2z'/>
      <path className={borderClassName} d='M258.7,368.7c-0.2-0.2-0.5-0.3-0.8-0.4c0.2,0.1,0.5,0.2,0.6,0.3L258.7,368.7z'/>
      <path className={borderClassName} d='M250.2,360.5c0-0.3-0.1-0.7-0.3-1C250,359.8,250.1,360.1,250.2,360.5L250.2,360.5z'/>
      <path className={coffeeClassName} d='M308,212.8c-11.8,5.1-25.3,10.8-42.7,10.8c-7.3,0-14.5-1-21.5-3l12,123.6c0.4,5.2,2.8,10,6.6,13.5
      ...
      <path className={borderClassName} d='M206.5,160.2l0.2,0.2l0.1,0.1C206.8,160.3,206.7,160.2,206.5,160.2z'/>
      <path className={borderClassName} d='M412.8,148.7l-1.8-9.1c-1.6-8.2-5.3-16-13.7-18.9c-2.7-0.9-5.8-1.4-7.8-3.3c-2.1-2-2.7-5-3.2-7.8
